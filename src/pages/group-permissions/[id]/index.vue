  ...
  <header class="p-4">
    <div class="flex justify-between">
      <div class="go-back flex">
        <router-link :to="{ name: '/page-permissions/' }" class="flex items-center p-1 px-3 bg-black rounded-md text-white">
          <Icon icon="heroicons-outline:arrow-left" class="text-xl" />
        </router-link>
